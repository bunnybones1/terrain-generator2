import { MeshStandardMaterial, PerspectiveCamera, Scene, ShaderMaterial } from "three";
...
export default class ScatteredObjectManager {
  ...
  constructor(
    ...
    terrainDepthMat: ShaderMaterial,
    private camera: PerspectiveCamera
  ) {
    // Trees systems: shoreline pines
    const treeLayers: TreeManager[] = [
      new TreeManager("pines-L", scene, terrainSampler, terrainMat, terrainDepthMat, 2001, {
        cellSize: 20,
    ...
    const stonesLayers: StonesManager[] = [
      ...
      new StonesManager("stones-XL", scene, terrainSampler, terrainMat, terrainDepthMat, 1001, {
        cellSize: 30,
      ...
      new StonesManager("stones-L", scene, terrainSampler, terrainMat, terrainDepthMat, 1002, {
        cellSize: 24,
        density: 0.0002,
        stoneRadius: 4,
        lodCapacities: [10, 20, 30, 40, 50],
      ...
      new StonesManager("stones-M", scene, terrainSampler, terrainMat, terrainDepthMat, 1003, {
        cellSize: 18,
        density: 0.003,
        stoneRadius: 2,
      ...
      new StonesManager("stones-S", scene, terrainSampler, terrainMat, terrainDepthMat, 1004, {
        cellSize: 12,
        density: 0.03,
        stoneRadius: 1,
      ...
      new StonesManager("stones-XS", scene, terrainSampler, terrainMat, terrainDepthMat, 1005, {
        cellSize: 8,
        density: 0.1,
        stoneRadius: 0.5,
